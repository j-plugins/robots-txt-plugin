...
public class RobotsTxtEntryImpl extends ASTWrapperPsiElement implements RobotsTxtEntry {

  public RobotsTxtEntryImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public RobotsTxtRule getRule() {
    return findChildByClass(RobotsTxtRule.class);
  }
